...
export const demoServices: HassServices = {
  homeassistant: {
    ...
    stop: { description: "Stop the ATMA Assist service.", fields: {} },
    restart: { description: "Restart the ATMA Assist service.", fields: {} },
    check_config: {
      description:
        "Check the ATMA Assist configuration files for errors. Errors will be displayed in the ATMA Assist log.",
      fields: {},
    },
    update_entity: {
