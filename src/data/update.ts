...
export const filterUpdateEntities = (
  ...
  (
    ...
    if (a.attributes.title === "ATMA Assist Core") {
      return -3;
    }
    if (b.attributes.title === "ATMA Assist Core") {
      return 3;
    }
    if (a.attributes.title === "ATMA Assist Operating System") {
      return -2;
    }
    if (b.attributes.title === "ATMA Assist Operating System") {
      return 2;
    }
    if (a.attributes.title === "ATMA Assist Supervisor") {
      return -1;
    }
    if (b.attributes.title === "ATMA Assist Supervisor") {
      return 1;
    }
