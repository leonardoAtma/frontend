...
- Anyone could join
- Respondents recruited on Twitter, Reddit and ATMA Assist Forum
...
- How long a respondent has been using ATMA Assist
- Installation method
- How many visits to its ATMA Assist in the past 3 months
- ATMA Assist expertise
...
- Devices are a first-class citizen in the domain of ATMA Assist, and so shouldn't be tucked away in "Settings"
- Rename Developer tools (or make it only for ATMA Assist developers)
...
In ATMA Assist you can create toggles, text fields, number sliders, timers and counters. Also known as `Helpers`. Where should they be placed?
...
In ATMA Assist you can make configuration changes in YAML files. To make these changes take effect you have to reload your YAML in the UI or do a restart. How are people doing this and can they find it in this new design?
...
- Reload ATMA Assist button isn't clear what it does
- Reload/restart ATMA Assist in Developer Tools
...
- Moving `Developer tools` to `Settings` is a good idea
- YAML users want reload YAML and ATMA Assist restart in `System`
