export default {
  ...
  "weather.demo_weather_south": {
    ...
    attributes: {
      ...
      pressure: 1099,
      wind_speed: 0.5,
      attribution: "Powered by ATMA Assist",
      forecast: [
        {
  ...
  "configurator.philips_hue": {
    ...
    attributes: {
      ...
      entity_picture: null,
      description:
        "Press the button on the bridge to register Philips Hue with ATMA Assist.\n\n![Description image](/static/images/config_philips_hue.jpg)",
