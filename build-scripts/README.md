# Bundling ATMA Assist Frontend

The ATMA Assist build pipeline contains various steps to prepare a build.
...
Currently in ATMA Assist we use a bundler to convert TypeScript, CSS and JSON files to JavaScript files that the browser understands.
